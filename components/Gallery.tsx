      ...
      <div className="max-w-[1180px] mx-auto px-6">
        ...
        <div className="flex justify-between items-end mb-8 flex-wrap gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-transparent text-white font-[family-name:var(--font-barlow)] font-bold text-[0.88rem] tracking-[1.5px] uppercase px-5 py-2.5 rounded border-2 border-white/40 hover:border-white hover:bg-white/8 transition-all"
          >
            Follow on Facebook
          </a>
        </div>
