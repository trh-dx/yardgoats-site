      ...
      <div className="max-w-[1180px] mx-auto px-6">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-transparent text-white font-barlow font-bold text-[0.88rem] tracking-[1.5px] uppercase px-5 py-2.5 rounded border-2 border-white/30 hover:border-white hover:bg-white/8 transition-all"
          >
